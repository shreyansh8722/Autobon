...
const FinanceForm = () => {
  ...
  const nextStep = () => {
    setStep((p) => Math.min(p + 1, 3)); // Changed to 5 steps total
  };
  ...
  // If we're on the success screen (step 5), show only that
  if (step === 5) {
  ...
  return (
    <div className="min-h-screen relative bg-white font-sans">
      <button className="fixed right-2 md:right-20 bottom-10">
        <img
          src="/call.png"
          alt="Call"
