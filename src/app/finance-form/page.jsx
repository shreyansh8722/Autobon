...
export default function PreQualifyPage() {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "phone") {
      ...
      if (numbers.length > 6) {
        newValue = `${numbers.substring(0, 3)}-${numbers.substring(3, 6)}-${numbers.substring(6)}`;
      } else if (numbers.length > 3) {
        newValue = `${numbers.substring(0, 3)}-${numbers.substring(3)}`;
      } else {
        newValue = numbers;
      }
    }
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-md p-3.5 text-sm focus:border-blue-600 focus:ring-4 focus:ring-blue-100 outline-none transition-all bg-white text-gray-900"
                />
              </div>
              <div>
                <label className="text-[13px] text-gray-400 font-medium mb-1 block">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3 lg:gap-4">
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full border border-gray-300 rounded-md p-3.5 text-sm outline-none appearance-none bg-no-repeat bg-[right_12px_center] bg-[length:14px] select-chevron bg-white"
                >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0"
                    onChange={handleInputChange}
                    className="w-full border border-gray-300 rounded-md p-3.5 pl-7 text-sm outline-none focus:border-blue-600 focus:ring-4 focus:ring-blue-100 transition-all"
                  />
                </div>
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-4 lg:gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  onChange={handleInputChange}
                  className="w-full border border-gray-300 rounded-md p-3.5 text-sm outline-none uppercase focus:border-blue-600 focus:ring-4 focus:ring-blue-100 transition-all"
                />
              </div>
            </div>
