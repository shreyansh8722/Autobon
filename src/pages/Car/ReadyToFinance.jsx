  ...
  return (
    <section className="w-full py-6">
      <div className="mx-auto overflow-hidden">
        <div className="relative bg-primary rounded-[16px] p-8 lg:p-6 flex flex-col items-center text-center overflow-hidden shadow-xl shadow-primary/20">
          ...
          <div className="relative z-10 flex flex-col items-center max-w-[500px]">
            <h2 className="text-xl  w-full lg:text-4xl text-start md:text-center font-semibold text-white mb-2   md:mb-4">
              Ready to finance?
            </h2>
            <p className="text-[#FFFFFF] text-[12px] lg:text-[17px]  text-start md:text-center font-medium leading-relaxed mb-4 md:mb-8">
