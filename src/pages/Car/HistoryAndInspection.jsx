...
const HistoryAndInspection = () => {
  ...
  return (
    <div id="history-inspection" className="w-full px-4 md:px-0 mt-6 font-sans">
      <h2 className="text-2xl lg:text-3xl font-bold text-[#272727] text-center mb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {sections.map((section, idx) => (
          <div
            key={idx}
            className="border bg-white border-border rounded-[14px] p-8 flex flex-col h-full hover:shadow-md transition-shadow duration-300"
          >
            {/* Header section with Image Icon */}
            <div className="flex items-start gap-4 mb-8">
              <div className="w-14 h-14 bg-primary rounded-full flex-shrink-0 flex items-center justify-center shadow-lg shadow-primary/20">
                <img
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[13px] text-[#606060] font-normal leading-snug mt-1">
                  {section.description}
                </p>
              </div>
            </div>

            {/* List items with small icon indicators */}
            <div className="flex-1 space-y-5">
              {section.items.map((item, i) => (
                ...
                >
                  ...
                  />
                  <span className="text-[15px] font-normal text-[#606060]">
                    {item}
                  </span>
                </div>
              ))}
            ...
            <div className="mt-10 pt-4 flex justify-end">
              <a
                ...
                } underline font-bold text-[15px] flex items-center gap-2 hover:opacity-80 decoration-2 underline-offset-4`}
              >
                {section.linkText}
                <ArrowRight size={16} />
              </a>
