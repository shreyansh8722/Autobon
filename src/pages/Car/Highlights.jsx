  ...
  return (
    ...
    >
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 border border-border rounded-[10px] overflow-hidden">
          {vehicleDetails.map((item, idx) => (
            <div
              key={idx}
              className={`p-5 py-8 flex flex-row items-center md:items-start gap-3 relative border-b md:border-b-0 md:border-r border-border last:border-0 md:last:border-r-0`}
            >
              ...
              <div>
                <p className="text-[12px] text-[#606060] font-medium leading-tight">
                  {item.label}
                </p>
                <p className="text-[14px] font-semibold mt-1 text-black leading-tight">
                  {item.value}
                </p>
              </div>
            </div>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="border border-border rounded-[10px] p-6 py-0 flex-1 flex flex-col justify-center ">
            <div className="flex flex-col items-center gap-0  ">
              ...
              <p className="text-[13px] w-full text-gray-500 mt-2 font-medium max-w-[200px] md:max-w-full">
