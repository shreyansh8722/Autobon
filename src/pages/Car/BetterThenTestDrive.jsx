...
const BetterThenTestDrive = () => {
  ...
  return (
    <section className="w-full py-[60px] lg:py-[100px] overflow-hidden bg-background">
      <style jsx>{`
      ...
      <div className="w-full flex flex-col items-center">
        <div className="flex flex-col items-center gap-4 mb-[40px] lg:mb-[60px] text-center px-6">
          <h2 className="text-[28px] lg:text-[36px] font-semibold text-black tracking-tight leading-tight max-w-[900px]">
            Better than a test drive – Try it for 10 days!
          </h2>
          <p className="text-[#606060] font-medium text-[12px] lg:text-[16px]">
