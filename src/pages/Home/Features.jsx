                ...
                <div className="relative z-10 w-full flex justify-center items-center overflow-hidden h-[190px] lg:h-[220px]">
                  {card.isAnimated ? (
                    <img
                      src={card.img.src}
                      alt={card.title}
                      className={`w-max relative md:left-3 h-max  bottom-3 max-w-[180px] md:max-w-[200px]  object-cover object-bottom transition-transform duration-500 group-hover:scale-105`}
                    />
                  ) : (
                    <img
                      src={card.img.src}
