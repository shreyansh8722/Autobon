...
const Footer = () => {
  ...
  const isMinimal = minimalFooterRoutes.includes(pathname);
  ...
  if (isMinimal) {
    return (
      <footer className="w-full bg-white lg:bg-[#fafafa] border-t border-gray-100">
        <div className="max-w-[1280px] mx-auto px-8 py-8 lg:py-10 flex flex-col lg:flex-row lg:justify-between lg:items-center">
          ...
          <div className="flex items-center gap-4 mt-6 lg:mt-0 justify-center lg:justify-end">
            <img
            ...
            <div className="flex flex-col items-center">
              <div className="text-blue-400 text-sm tracking-widest">★★★★★</div>
              <p className="text-[9px] font-extrabold text-gray-500 uppercase tracking-tighter mt-0.5">
